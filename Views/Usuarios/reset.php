		...
		<div class="authentication-reset-password d-flex align-items-center justify-content-center">
			...
			<div class="card-body">
									<div class="p-5">
										...
										<p class="text-muted">Su contraseña será cambiada. Por favor, ingrese su nueva contraseña.</p>
										<div class="mb-3 mt-5">
											<label class="form-label">Ingrese su nueva contraseña<span class="text-danger fw-bold">*</span></label>
											<input type="password" class="form-control" id="nueva_clave" placeholder="Contraseña nueva" />
										</div>
										<div class="mb-3">
											<label class="form-label">Confirme su nueva contraseña<span class="text-danger fw-bold">*</span></label>
											<input type="password" class="form-control" id="confirmar_clave" placeholder="Confirmar contraseña" />
										</div>
										<div class="d-grid gap-2">
											<button type="button" class="btn btn-primary" id="btnAccion">Cambiar Contraseña</button> <a href="<?php echo base_url;?>" class="btn btn-light"><i class='bx bx-arrow-back mr-1'></i>Volver al menú principal</a>
										</div>
									</div>
								</div>
			</div>
